...
export const metadata: Metadata = {
  ...
  keywords: [
    "plumber Lucan", "plumber Dublin", "emergency plumber Dublin",
    "boiler repair Lucan", "heating engineer Dublin", "24 hour plumber Dublin",
    "Aspect Plumbing and Heating",
  ],
  openGraph: {
    title: `${site.name} | Lucan & Dublin`,
    description: site.description,
    type: "website", locale: "en_IE", siteName: site.name,
  },
...
const jsonLd = {
  ...
  address: {
    ...
    addressLocality: "Lucan", addressRegion: "Co. Dublin",
    postalCode: site.address.eircode, addressCountry: "IE",
  },
  areaServed: site.serviceArea.map((name) => ({ "@type": "City", name })),
  aggregateRating: {
    "@type": "AggregateRating",
    ratingValue: site.rating.score, reviewCount: site.rating.count,
  },
};
